    ...
    <header className="bg-white py-4 shadow-md">
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        <div className="hidden items-center space-x-4 md:flex">
          ...
          <Link href="/sign-in" className="text-gray-700 hover:text-blue-600">Sign In</Link>
          <Link href="/sign-up" className="ml-4 rounded-lg bg-blue-600 px-4 py-2 text-white">Sign Up</Link>
